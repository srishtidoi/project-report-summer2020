...
% feynman diag, cutlfow, equation, obj sel, event sel, sro
...
\begin{table}
  ...
  \resizebox{\textwidth}{!}{%
    \begin{tabular}{c|c|c|c}
      ...
      \multirow{2}{*}{\textbf{Sample (Mass Point)}} & \multirow{2}{*}{\textbf{Total Number of Events}} &
      ...
      \hline
      \rule{0pt}{7ex}    
      100 $\GeV$ & 299200 & 0.830 & 360.482 \\
      150 $\GeV$ & 286200 & 0.119 & 2405.042 \\
      400 $\GeV$ & 200000 & 0.00272 & 73529.411 \\
       & & & \\    
      \hline \hline
...
\begin{table}
  ...
  \begin{tabular}{l}
    \hline \hline
    \\
    \centerline{Triggers for leading light lepton ($e/\mu$)}\\
    \\
  $\sbullet \hspace{0.2cm}$ Muons $\pt>26(29) \GeV$ for $2016$ \& $2018(2017)$\\
  $\sbullet \hspace{0.2cm}$ Electrons $\pt>30(35) \GeV$ for $2016(2017$ \& $2018)$\\
  \\
  \hline
  \\
  \centerline{Trigger (in data only)}\\
  $\sbullet \hspace{0.2cm}$ $2016$:\\
  $\hspace{1cm}1. \hspace{0.2cm}$ For Single Muon PD, HLT\_IsoMu24 \& HLT\_IsoTkMu24\\
  $\hspace{1cm}2. \hspace{0.2cm}$ For Single Electron PD, HLT\_Ele27\_WPTight\_Gsf\\
  $\sbullet \hspace{0.2cm}$ $2017$:\\
  $\hspace{1cm}1. \hspace{0.2cm}$ For Single Muon PD, HLT\_IsoMu27\\
  $\hspace{1cm}2. \hspace{0.2cm}$ For Single Electron PD, HLT\_Ele32\_WPTight\_Gsf \& HLT\_Ele32\_WPTight\_Gsf\_L1DoubleEG\\
  $\sbullet \hspace{0.2cm}$ $2018$:\\
  $\hspace{1cm}1. \hspace{0.2cm}$ For Single Muon PD, HLT\_IsoMu24\\
  $\hspace{1cm}2. \hspace{0.2cm}$ For Single Electron PD, HLT\_Ele32\_WPTight\_Gsf\\
  \\
  \hline \hline
