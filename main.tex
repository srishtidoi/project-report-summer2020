...
\begin{figure}
  \begin{adjustbox}{minipage=\textwidth, scale=0.75}
    \centering
    \subfloat[DY]{{\includegraphics[width=0.3\textwidth]{DYfeynman.png} }}%
    \qquad
    \subfloat[\ttbar]{{\includegraphics[width=0.3\textwidth]{ttbarfeynman.png} }}%
...
\begin{figure}[h]
\centering
\subfloat[{\scriptsize RHN \pT}]{{\includegraphics[trim=0 0 0 50,clip, width=0.3\textwidth]{RHN_pT.png} }}%
\qquad
\subfloat[{\scriptsize PDG-ID of RHN Mothers}]{{\includegraphics[trim=0 0 0 50,clip, width=0.3\textwidth]{RHN_momid.png} }}%

\subfloat[{\scriptsize\pT{} of $\tau$ coming from PV }]{{\includegraphics[trim=0 0 0 50,clip, width=0.3\textwidth]{pvtaupt.png} }}%
\qquad
\subfloat[{\scriptsize \DeltaR{} (RHN,$\tau$)}]{{\includegraphics[trim=0 0 0 50,clip, width=0.3\textwidth]{pvtaudRRHN.png} }}%
...
\begin{figure}[h]
\centering
\subfloat[{\scriptsize $\ell_{1}$ Mother PDG-ID}]{{\includegraphics[trim=0 0 0 50,clip, width=0.3\textwidth]{2L1T_OS_momidL1.png} }}%
\quad
\subfloat[{\scriptsize $\ell_{2}$ Mother PDG-ID}]{{\includegraphics[trim=0 0 0 50,clip, width=0.3\textwidth]{2L1T_OS_momidL2.png} }}%
\quad
\subfloat[{\scriptsize $\tau$ Mother PDG-ID }]{{\includegraphics[trim=0 0 0 50,clip, width=0.3\textwidth]{2L1T_OS_momidT.png} }}%
\quad
...
\begin{figure}[h]
  \centering
  \subfloat[OS]{{\includegraphics[width=0.4\textwidth]{2l1tOSfeynman.png} }}%
  \qquad
  \subfloat[SS]{{\includegraphics[width=0.4\textwidth]{2l1tSSfeynman.png} }}%
...
\begin{figure}[h]
\centering
\subfloat[{\scriptsize $\ell_{1}$ Mother PDG-ID}]{{\includegraphics[trim=0 0 0 50,clip, width=0.3\textwidth]{2L1T_SS_momidL1.png} }}%
\quad
\subfloat[{\scriptsize $\ell_{2}$ Mother PDG-ID}]{{\includegraphics[trim=0 0 0 50,clip, width=0.3\textwidth]{2L1T_SS_momidL1L2.png} }}%
\quad
\subfloat[{\scriptsize $\tau$ Mother PDG-ID }]{{\includegraphics[trim=0 0 0 50,clip, width=0.3\textwidth]{2L1T_SS_momidT.png} }}%
\quad
...
\begin{figure}[h]
\centering
\subfloat[{\scriptsize $\tau_{1}$ Mother PDG-ID}]{{\includegraphics[trim=0 0 0 50,clip, width=0.3\textwidth]{1L2T_momidT1.png} }}%
\quad
\subfloat[{\scriptsize $\tau_{2}$ Mother PDG-ID}]{{\includegraphics[trim=0 0 0 50,clip, width=0.3\textwidth]{1L2T_momidT2.png} }}%
\quad
\subfloat[{\scriptsize $\ell$ Mother PDG-ID }]{{\includegraphics[trim=0 0 0 50,clip, width=0.3\textwidth]{1L2T_momidL.png} }}%
\quad
