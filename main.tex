...
\begin{figure}[h!]
  ...
  \makebox[0pt][c]{%
    ...
    \qquad
    \subfloat[{\scriptsize $m_{T}$ ($\tau$, \met) [\GeV]}]{{\includegraphics[trim=0 0 0 45,clip, width=0.45\textwidth]{images/ss/mt0.png} }}%
  }
...
\begin{figure}[h!]
  ...
  \caption{Some basic distributions for the \3l-OSSF below-\Zboson{} channel. From the \pt{} plots, we observe that the odd lepton is often the leading lepton, \ie{} the OSSF pair is often of the lower \pt{} leptons. }
...
\begin{figure}[h]
  \centering
  \subfloat[{\scriptsize \DeltaR{} (OSSF pair)}]{{\includegraphics[trim=0 0 0 40,clip, width=0.3\textwidth]{images/3lossf/3lc1-1.png} }}%
  \subfloat{{\includegraphics[trim=0 -2700 0 -2700,clip, height=4.5cm, width=0.05\textwidth]{images/plus.png} }}%
  \subfloat[{\scriptsize \ptmiss{} [\GeV]}]{{\includegraphics[trim=0 0 0 40,clip, width=0.3\textwidth]{images/3lossf/3lc1-2.png} }}%
  \subfloat{{\includegraphics[trim=0 -1400 0 -1400,clip, height=4.5cm, width=0.05\textwidth]{images/right-arrow.png} }}%
  \subfloat[{\scriptsize \Lt{} [\GeV]}]{{\includegraphics[trim=0 0 0 45,clip, width=0.3\textwidth]{images/3lossf/3lc1lt.png} }}%
  \vspace{0.6cm}
  \tiny
  \setlength{\tabcolsep}{20pt}
  \renewcommand{\arraystretch}{1.6}
...
\begin{figure}[h]
  \centering
  \subfloat[{\scriptsize $m_{T}$ (\ll, \met) [\GeV]}]{{\includegraphics[trim=0 0 0 40,clip, width=0.3\textwidth]{images/3lossf/3lc3-1.png} }}%
  \subfloat{{\includegraphics[trim=0 -2700 0 -2700,clip, height=4.5cm, width=0.05\textwidth]{images/plus.png} }}%
  \subfloat[{\scriptsize \dphi{} (\lodd, $\ell_{OSSF_{1}}$)}]{{\includegraphics[trim=0 0 0 40,clip, width=0.3\textwidth]{images/3lossf/3lc3-2.png} }}%
  \subfloat{{\includegraphics[trim=0 -1400 0 -1400,clip, height=4.5cm, width=0.05\textwidth]{images/right-arrow.png} }}%
  \subfloat[{\scriptsize \Lt{} [\GeV]}]{{\includegraphics[trim=0 0 0 45,clip, width=0.3\textwidth]{images/3lossf/3lc3lt.png} }}%
  \vspace{0.6cm}
  \tiny
  \setlength{\tabcolsep}{20pt}
  \renewcommand{\arraystretch}{1.6}
...
\begin{figure}[h]
  \centering
  \subfloat[{\scriptsize \DeltaR{} (OSSF pair)}]{{\includegraphics[trim=0 0 0 40,clip, width=0.3\textwidth]{images/3lossf/3lc2-1.png} }}%
  \subfloat{{\includegraphics[trim=0 -2700 0 -2700,clip, height=4.5cm, width=0.05\textwidth]{images/plus.png} }}%
  \subfloat[{\scriptsize \dphi{} (\lodd, $\ell_{OSSF_{2}}$)}]{{\includegraphics[trim=0 0 0 40,clip, width=0.3\textwidth]{images/3lossf/3lc2-2.png} }}%
  \subfloat{{\includegraphics[trim=0 -1400 0 -1400,clip, height=4.5cm, width=0.05\textwidth]{images/right-arrow.png} }}%
  \subfloat[{\scriptsize \Lt{} [\GeV]}]{{\includegraphics[trim=0 0 0 45,clip, width=0.3\textwidth]{images/3lossf/3lc2lt.png} }}%
  \vspace{0.6cm}
  \tiny
  \setlength{\tabcolsep}{20pt}
  \renewcommand{\arraystretch}{1.6}
...
\begin{figure}[h]
  \centering
  \subfloat[{\scriptsize \pt{} (\ls) [\GeV]}]{{\includegraphics[trim=0 0 0 40,clip, width=0.45\textwidth]{images/3losof/3lc4.png} }}%
  \subfloat{{\includegraphics[trim=0 -1400 0 -1400,clip, height=7cm, width=0.1\textwidth]{images/right-arrow.png} }}%
  \subfloat[{\scriptsize \Lt{} [\GeV]}]{{\includegraphics[trim=0 0 0 45,clip, width=0.45\textwidth]{images/3losof/3lc4lt.png} }}%
  \vspace{0.6cm}
  \tiny
  \setlength{\tabcolsep}{20pt}
  \renewcommand{\arraystretch}{1.6}
  \begin{tabular}{|c|c|}
    ...
    \hline
  \end{tabular}
  \caption{\pt{} (\ls) $>30$ for \3l-OSOF below-\Zboson{} events.}
  \label{fig:3lc4}
\end{figure}
...
\begin{table}
  ...
  \caption{A summary of all the channels considered for signal region optimization.}
  \label{tab:results}
\end{table}
